    ...
    import { fixture } from "../../hooks/pageFixture";
            ...
            let checkOutDate:string;
                    ...
                    await expect(fixture.page.getByRole('link', { name: 'Shady Meadows B&B' })).toBeVisible();
                    });
        ...
        // Fill Check Out
    const checkOutBox = fixture.page.locator('div').filter({
            hasText: 'Check Out' 
        }).getByRole('textbox').nth(1); 

        await checkOutBox.fill(checkOutDate);
        // Click Check Availability
        await fixture.page.getByRole('button', { name: 'Check Availability' }).click();
    });
        ...
        switch(roomType){
        case 'Single':
        await fixture.page.locator('div')
    ...
    await fixture.page.getByRole('button', { name: 'Reserve Now' }).click();
    await fixture.page.getByRole('textbox', { name: 'Firstname' }).fill(firstName);
    await fixture.page.getByRole('textbox', { name: 'Lastname' }).fill(lastName);
    await fixture.page.getByRole('textbox', { name: 'Email' }).fill(email);
    await fixture.page.getByRole('textbox', { name: 'Phone' }).fill(phone);
    await fixture.page.getByRole('button', { name: 'Reserve Now' }).click();
            ...
            await expect(fixture.page.getByRole('alert').filter({ hasText: 'size must be between 3 and' })).toBeVisible();
            });

            Then('user should see success message', async function () {
            await expect(fixture.page.locator('h2', { hasText: 'Booking Confirmed' })).toBeVisible();
            await expect(fixture.page.locator('strong')).toContainText([todayDate, checkOutDate]);
            });
